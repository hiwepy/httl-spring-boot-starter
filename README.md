...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/httl-spring-boot-starter)](https://github.com/easy-4-java/httl-spring-boot-starter)
...
> **Artifact ID**：`httl-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**httl-spring-boot-starter** is a Spring Boot starter that integrates **httl** for applications using httl. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume httl capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using httl |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for httl |
| JDK | `17` |
| Coordinates | `io.github.easy4j:httl-spring-boot-starter:3.1.x.20260527-SNAPSHOT` |
| Config Prefix | `httl` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers httl beans automatically |
| Property Binding | ✅ Stable | Binds `httl.*` to `HttlProperties` |
| `FreeMarkerConfigurationFactoryBean` bean | ✅ Stable | Auto-registered via HttlAutoConfiguration |
...
| `HttlViewResolver` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `httl.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl httl-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `httl.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/httl-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/httl-spring-boot-starter)
